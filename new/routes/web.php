...
// Front-End //
Route::get('/', 'Frontpages\FrontendpagesController@index')->name('index');
Route::get('/form/form', 'Frontpages\FrontendpagesController@form')->name('form');
Route::get('/contacts', 'Frontpages\FrontendpagesController@contacts')->name('contacts');
Route::get('/contact', 'Frontpages\FrontendpagesController@contact')->name('contact');
Route::get('/affiliate', 'Frontpages\FrontendpagesController@affiliate')->name('affiliate');
Route::get('/become-an-affiliate', 'Frontpages\FrontendpagesController@affiliate')->name('affiliate');
Route::get('/privacy', 'Frontpages\FrontendpagesController@privacy')->name('privacy');
Route::get('/termsofservice', 'Frontpages\FrontendpagesController@termsofservice')->name('termsofservice');
Route::get('/terms', 'Frontpages\FrontendpagesController@terms')->name('terms');
Route::get('/licenses-disclosures', 'Frontpages\FrontendpagesController@licenses-disclosures')->name('licenses-disclosures');
Route::get('/licenses', 'Frontpages\FrontendpagesController@licenses')->name('licenses');
Route::get('/feedback', 'Frontpages\FrontendpagesController@feedback')->name('feedback');
Route::get('/team', 'Frontpages\FrontendpagesController@team')->name('team');
Route::get('/advisors', 'Frontpages\FrontendpagesController@advisors')->name('advisors');
Route::get('/investors', 'Frontpages\FrontendpagesController@investors')->name('investors');
Route::get('/careers', 'Frontpages\FrontendpagesController@careers')->name('careers');
Route::get('/fees', 'Frontpages\FrontendpagesController@fees')->name('fees');
Route::get('/news', 'Frontpages\FrontendpagesController@news')->name('news');
Route::get('/faq', 'Frontpages\FrontendpagesController@faq')->name('faq');
Route::get('/resource-center', 'Frontpages\FrontendpagesController@resource_center')->name('resource_center');
Route::get('/refer-a-friend', 'Frontpages\FrontendpagesController@refer_a_friend')->name('refer_a_friend');
Route::get('/prohibited-uses', 'Frontpages\FrontendpagesController@prohibited-uses')->name('prohibited-uses');
Route::get('/products', 'Frontpages\FrontendpagesController@products')->name('products');
Route::get('/interest-account', 'Frontpages\FrontendpagesController@interest-account')->name('interest-account');
Route::get('/crypto-loans', 'Frontpages\FrontendpagesController@cryptoloans_frontpage')->name('cryptoloans_frontpage');
Route::get('/trading', 'Frontpages\FrontendpagesController@trading')->name('trading');
Route::get('/institutions', 'Frontpages\FrontendpagesController@institutions')->name('institutions');
Route::get('/our-rates', 'Frontpages\FrontendpagesController@our-rates')->name('our-rates');
Route::get('/rates', 'Frontpages\FrontendpagesController@rates')->name('rates');
Route::get('/blog', 'Frontpages\FrontendpagesController@blog')->name('blog');
Route::get('/help-center', 'Frontpages\FrontendpagesController@help-center')->name('help-center');
Route::get('/crypto-interest-account', 'Frontpages\FrontendpagesController@cryptointerestaccount')->name('cryptointerestaccount');
Route::get('/earn-crypto', 'Frontpages\FrontendpagesController@earn-crypto')->name('earn-crypto');
Route::get('/how-to-get-a-bitcoin-loan', 'Frontpages\FrontendpagesController@howtogetabitcoinloan')->name('howtogetabitcoinloan');
Route::get('/earn-bitcoin-interest', 'Frontpages\FrontendpagesController@earnbitcoininterest')->name('earnbitcoininterest');
Route::get('/home-loans', 'Frontpages\FrontendpagesController@home-loans')->name('home-loans');
Route::get('/refinance-debt', 'Frontpages\FrontendpagesController@refinance-debt')->name('refinance-debt');
Route::get('/fund-crypto-mining', 'Frontpages\FrontendpagesController@fund-crypto-mining')->name('fund-crypto-mining');
Route::get('/auto-loan', 'Frontpages\FrontendpagesController@auto-loan')->name('auto-loan');
// Front-End //
